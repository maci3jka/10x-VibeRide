...
#### Generate Mapy.cz Link
- **Method**: `GET`
- **Path**: `/api/itineraries/:itineraryId/mapy`
- **Description**: Generates a Mapy.cz URL with route parameters for viewing itinerary in web interface
- **Auth**: Required
- **Path Parameters**:
  - `itineraryId` (uuid, required) - Itinerary identifier
- **Query Parameters**:
