...
## Objective
Implement a REST API endpoint based on a provided implementation plan with proper validation, error handling, and organized code structure.
...
- [ ] Update `.ai/api-plan.md` with endpoint details:
