...
/**
 * Google OAuth sign-in button with loading state
 * Handles client-side OAuth initiation with PKCE flow
 */
export function GoogleSignInButton({ returnTo }: GoogleSignInButtonProps) {
  ...
  const handleSignIn = async () => {
    ...
    try {
      // Build callback URL with returnTo parameter if provided (US-014)
