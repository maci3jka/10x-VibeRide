        ...
        <div className="rounded-lg border border-muted bg-muted/30 p-3">
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <p>
                <strong>GPX:</strong> Use with Garmin, TomTom, and most GPS navigation devices. Compatible with apps
                like Google Maps, Komoot, and Ride with GPS.
              </p>
              <p>
                <strong>KML:</strong> Use with Google Earth and Google Maps. Includes styled routes and waypoints with
                custom icons and descriptions.
              </p>
              <p>
                <strong>GeoJSON:</strong> Use for web mapping libraries (Leaflet, Mapbox), custom applications, or data
                analysis tools.
              </p>
            </div>
          </div>
        ...
        {showDisclaimer && (
          <Alert>
            <AlertDescription className="space-y-3">
              ...
              <p className="text-sm">
                This itinerary is generated by AI and provided for informational purposes only. Always verify routes,
                road conditions, and local regulations before riding. Ride within your skill level and always prioritize
                safety. VibeRide is not responsible for any accidents, injuries, or damages that may occur while using
                this itinerary.
              </p>
