        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6 text-center">
            <div className="space-y-4">
              <h1 className="text-5xl sm:text-6xl font-bold tracking-tight">VibeRide</h1>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="bg-card border border-border rounded-lg p-6 text-center space-y-3">
              ...
              <h3 className="text-lg font-semibold">Simple Notes</h3>
              <p className="text-sm text-muted-foreground">Jot down your ride ideas in plain text</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-6 text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">Let AI craft detailed itineraries</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-6 text-center space-y-3">
              ...
              <h3 className="text-lg font-semibold">Ready to Ride</h3>
              <p className="text-sm text-muted-foreground">Download GPX files for your GPS</p>
            </div>
          </div>
